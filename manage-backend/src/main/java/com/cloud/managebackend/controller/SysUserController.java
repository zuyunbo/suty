...
public class SysUserController {
    ...
    public Object page(SysUserParam queryParam){
        PageInfo pageInfo = sysUserService.pageQuery(queryParam);
    ...
    @ApiOperation("保存")
    public Object save(@RequestBody SysUser entity) {
    ...
    @ApiOperation("修改")
    public Object update(@RequestBody SysUser entity) {
